...
\newcommand{\myProf}{Prof. Dr. Antonio Francisco Díaz García\xspace}
...
\newcommand{\myKeywords}{Criptografía, Sistemas operativos, C, Pluggable Authentication Module, Autenticación, Message Queuing Telemetry Transport, Seguridad, Criptografía de Curva Elíptica, Algoritmo de Firma Digital de Curva Elíptica, Computación del Altas Prestaciones, Nube\xspace}
\newcommand{\myKeywordsEN}{Criptography, Operative System, C, Pluggable Authentication Module, Authentication, Message Queuing Telemetry Transport, Security, Elliptic Curve Criptography, Elliptic Curve Digital Signature Algorithm, High Performance Computing, Cloud}
